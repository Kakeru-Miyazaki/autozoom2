...
buttonAdd = tkinter.Button(root, text="Add URL", command=addUrl, width=10, height=5, font=("", "20"))
buttonAdd.grid(column=0, row=1, sticky=tkinter.S, padx=20, pady=5)
buttonDel = tkinter.Button(root, text="Delete URL", command=delUrl, width=10, height=5, font=("", "20"))
